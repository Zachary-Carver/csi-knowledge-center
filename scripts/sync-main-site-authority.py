...
def write_html(primary,observed,excluded,added,removed,generated_at):
    ...
    content = content.replace(
        "Live-synchronized registry of CSI: Clean Scene Investigators main-site URLs from the canonical GoDaddy sitemap, with blog and system routes identified separately.",
    ...
    content = content.replace("canonical GoDaddy sitemap", "canonical main-site sitemap")
    content = content.replace("live GoDaddy sitemap", "live main-site sitemap")
